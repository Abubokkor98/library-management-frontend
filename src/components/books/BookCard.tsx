...
export function BookCard({ book }: { book: IBook }) {
  ...
  return (
    <Card className="group relative h-full transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 border-0 bg-card/50 backdrop-blur-sm hover:bg-card/80 overflow-hidden">
      ...
      <CardFooter className="pt-0 relative z-10">
        <div className="flex justify-center w-full">
          <Button
            ...
            className="w-4/5 text-xs h-8 px-3 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200"
          >
            View Details
          </Button>
        </div>
